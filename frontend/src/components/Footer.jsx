        ...
        <div className="grid gap-8 lg:grid-cols-4 place-items-center lg:place-items-start text-center lg:text-left">
          ...
          <nav className="col-span-1 w-full max-w-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm text-gray-600">
              <li>
                <Link className="hover:text-gray-900" to="/squad">
                  Jucători
                </Link>
              </li>
              <li>
                <Link className="hover:text-gray-900" to="/matches">
                  Meciuri
                </Link>
              </li>
              <li>
                <Link className="hover:text-gray-900" to="/results">
                  Rezultate
                </Link>
              </li>
              <li>
                <Link className="hover:text-gray-900" to="/standings">
                  Clasament
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1 w-full max-w-sm">
            ...
            {/* Hartă Google Maps (interactivă) – compact */}
            <div className="mt-4 rounded-xl overflow-hidden ring-1 ring-gray-200 shadow-sm max-w-[300px] mx-auto lg:mx-0">
              <iframe
                ...
                className="w-full h-40 md:h-48" // <- mai mic decât h-56/md:h-64
              />
            </div>
            <a
              href={MAP_LINK}
