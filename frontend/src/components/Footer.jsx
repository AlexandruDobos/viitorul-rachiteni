    ...
    <footer role="contentinfo" className="mt-10">
      ...
      <div className="bg-gradient-to-r from-blue-50/70 via-indigo-50/70 to-sky-50/70 backdrop-blur-md border-t border-gray-200">
        <div className="mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-10 py-10">
          {/* Card translucid – look fresh */}
          <div className="rounded-3xl bg-white/70 ring-1 ring-indigo-100/60 shadow-sm p-6 sm:p-8">
            {/* Grid principal – CENTRAT pe mobil, aliniat stânga de la lg */}
            <div className="grid gap-10 lg:grid-cols-4 place-items-center lg:place-items-start text-center lg:text-left text-gray-800">
              {/* Brand */}
              ...
              {/* Linkuri rapide – grilă pe mobil pentru look curat */}
              <nav className="w-full max-w-sm">
                <h3 className="text-sm font-semibold text-gray-900">Navigație</h3>
                <ul className="mt-3 grid grid-cols-2 gap-y-2 gap-x-6 text-sm text-gray-700/90 justify-items-center lg:justify-items-start">
              ...
              <div className="w-full max-w-sm">
                ...
                <Link
                  to="/donations"
                  className="inline-flex mt-4 items-center gap-2 rounded-full px-5 py-2.5 text-white
              ...
              {/* Contact + hartă – complet centrat pe mobil */}
              <div className="w-full max-w-sm">
                ...
                <div className="mt-4 rounded-2xl overflow-hidden ring-1 ring-indigo-100 shadow-sm w-full max-w-[320px] mx-auto lg:mx-0">
                  <iframe
            ...
            {/* Sub-footer */}
            <div className="mt-10 border-t border-white/80 pt-4 text-xs text-gray-700/90 flex flex-col items-center gap-3 text-center lg:flex-row lg:justify-between lg:text-left">
              <div>© {year} ACS Viitorul Răchiteni. Toate drepturile rezervate.</div>

              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                <span>Vrei și tu un astfel de site?</span>
                <a href="tel:+40733305547" className="font-medium text-gray-900 hover:opacity-80">
                  +40 733 305 547
                </a>
