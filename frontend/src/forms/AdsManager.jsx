...
const AdsManager = () => {
  // Apply mobile-only top offset under the fixed admin bar
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      <div
        className="space-y-6"
        style={{
          paddingTop: isMobile ? "calc(env(safe-area-inset-top, 0px) + 56px)" : 0,
        }}
      >
        {/* hidden file input */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="inline-flex rounded-xl border border-gray-200 bg-white overflow-hidden">
            <button
              ...
              className={`px-3 py-1.5 text-sm transition ${filterDevice === "LAPTOP"
            ...
            <button
              ...
              className={`px-3 py-1.5 text-sm transition ${filterDevice === "MOBILE"
                  ? "bg-gradient-to-r " + blueGrad + " text-white"
                  : "hover:bg-gray-50 text-gray-700"
                }`}
            >
        ...
        {successMessage && (
          <div className="rounded-lg bg-green-50 text-green-700 ring-1 ring-green-200 px-3 py-2 text-sm">
            {successMessage}
          </div>
        )}
